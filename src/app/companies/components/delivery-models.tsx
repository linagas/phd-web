...
export default function DeliveryModels() {
  ...
  return (
    <section className="w-full md:py-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
        ...
        <div className="bg-gradient-to-r from-blue-400 to-blue-500 p-8 text-white">
          <span className="hidden md:inline-block bg-white text-blue-500 text-sm font-semibold px-3 py-1 rounded-full mb-4">
          Flexible
          </span>
        ...
        <div className="bg-gradient-to-r from-pink-400 to-red-400 p-8 text-white">
          <span className="hidden md:inline-block bg-white text-pink-500 text-sm font-semibold px-3 py-1 rounded-full mb-4">
          Mensual
          </span>
        ...
        <div className="p-8">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-lg mt-8 hidden md:block">
